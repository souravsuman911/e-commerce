package com.demo.cartservice.config;

import com.demo.cartservice.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/cart/**").hasRole("USER")  // only logged-in users can modify cart
